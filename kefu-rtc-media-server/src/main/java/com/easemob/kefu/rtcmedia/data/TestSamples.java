...
public class TestSamples {
    ...
    private static final String AGENT_ID = "cafebabe-bb24-4762-987e-bb0bd71d1234";
    private static final String VISITOR_ID = "cafebabe-bb24-4762-987e-bb0bd71da8fc";
    ...
    public static ImmutableList<String> users() {
        return ImmutableList.<String>builder().add(USER1).add(USER2).build();
    }
